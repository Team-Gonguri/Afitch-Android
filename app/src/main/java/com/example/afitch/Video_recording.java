...
public class Video_recording extends AppCompatActivity {
    ...
    private TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture,
            ...
            Log.d("mSurface", "onSurfaceTextureAvailable");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoView = findViewById(R.id.showVideo);
    ...
    protected void prepareVideoViewVideo() {
        ...
        videoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                Log.d("순서", "영상끝");
                Intent intent = new Intent(getApplicationContext(), Video_finish.class);
...
//                stopBackgroundThread();
    ...
    private void requestVideoPermissions() {
        Log.d("허가", "requestVideoPermission");
    ...
    private void openCamera(int width, int height) {
        ...
        if (!hasPermissionsGranted(VIDEO_PERMISSIONS)) {
            Log.d("허가", "!hasPermissionsGranted");
        ...
        try {
            Log.d(TAG, "openCamera - manager 설정");
            ...
            Toast.makeText(Video_recording.this, "Cannot access the camera.", Toast.LENGTH_SHORT).show();
            finish();
            ...
            mCameraDevice.createCaptureSession(Collections.singletonList(previewSurface),
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigureFailed(@NonNull CameraCaptureSession session) {
                            Toast.makeText(Video_recording.this, "Failed", Toast.LENGTH_SHORT).show();
                        }
                    }, mBackgroundHandler);
        } catch (CameraAccessException e) {
            e.printStackTrace();
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        File path = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).getAbsolutePath() + "/camtest");
        if (!path.exists()) {
            path.mkdirs();
        }
    ...
    private void stopRecordingVideo() {
        ...
        Toast.makeText(Video_recording.this, "Video saved: " + mNextVideoAbsolutePath,
